...
public class BANDPixels {
    ...
    public void initHistograms(String hipoFile, double adcRange) {
		...
		for( int lr = 1 ; lr < 3 ; lr++){
			H2_at_Hist.add( is, ip, lr+1 , new H2F("rawTDC_rawADC_"+iid,	80,0,400, 600,0,1500) );
		}
            ...
            for (int lr=1 ; lr<3 ; lr++){
                ...
                H2_a_Hist.add(is, 0, 14+lr,new H2F("fadc_rawT_"+iid,	80,0,400,	nstr[is-1],1.,nend));

    			H2_at_Hist.add( is, 0, lr-1 , new H2F("rawADCInt_rawTDCTime"+iid,	75,0,15000, 600,0,1500) );
                ...
                H2_t_Hist.add(is, 0, lr, new H2F("t_raw_"+iid+0,      600,   0, 1500, nstr[is-1], 1., nend));
